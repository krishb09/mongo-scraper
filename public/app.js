...
$.getJSON("/articles", function(data) {
    ...
    for (var i = 0; i < 10; i++) {
      ...
      var newButton1 = $("  <button type='button' class='btn btn-primary'>Save Article</button>"); 
      var newButton2 = $("  <button type='button' class='btn btn-secondary'>Make a Note</button>"); 
